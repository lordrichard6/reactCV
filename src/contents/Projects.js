    ...
    render() {
        return (
            <div className='condiv'>
                ...
                <ProjectCard back={img1} title='Face Detection App' link='https://github.com/lordrichard6/faceRecognition' tool='Reactjs' text=''/>
                <ProjectCard back={img2} title='RoboFriends' link='https://github.com/lordrichard6/robofriends' tool='React-Redux' text=''/>
                <ProjectCard back={img3} title='Netflix' link='https://github.com/lordrichard6/netflix_landingpage' tool='HTML5, CSS' text=''/>
                <ProjectCard back={img4} title='FlappyBird' link='https://github.com/lordrichard6/flappyBird' tool='Vanila JS' text=''/>
                <ProjectCard back={img5} title='Calculator' link='https://github.com/lordrichard6/calculator' tool='Vanila JS' text=''/>
